...
`define TV_OUT_CONV_BUS "../tv/rtldatafile/rtl.top.autotvout_CONV_BUS.dat"
 ...
 parameter CONV_BUS_DATA_BITWIDTH = 32'd 128;
...
parameter CONV_BUS_C_DATA_BITWIDTH = 32'd 128;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > CONV_BUS_mem_depth) begin
                $display ("D:/FPGA/SDA/SDA/solution1/sim/verilog/AESL_axi_master_CONV_BUS.v: Write request address %d exceed AXI master CONV_BUS array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, CONV_BUS_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > CONV_BUS_mem_depth) begin
                $display ("D:/FPGA/SDA/SDA/solution1/sim/verilog/AESL_axi_master_CONV_BUS.v: Read request address %d exceed AXI master CONV_BUS array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, CONV_BUS_mem_depth); 
                $finish;
            end
