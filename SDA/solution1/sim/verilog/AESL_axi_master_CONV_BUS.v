...
module AESL_axi_master_CONV_BUS (
    clk,
    reset,
    TRAN_CONV_BUS_AWVALID,
    TRAN_CONV_BUS_AWREADY,
    TRAN_CONV_BUS_AWADDR,
    TRAN_CONV_BUS_AWID,
    TRAN_CONV_BUS_AWLEN,
    TRAN_CONV_BUS_AWSIZE,
    TRAN_CONV_BUS_AWBURST,
    TRAN_CONV_BUS_AWLOCK,
    TRAN_CONV_BUS_AWCACHE,
    TRAN_CONV_BUS_AWPROT,
    TRAN_CONV_BUS_AWQOS,
    TRAN_CONV_BUS_AWREGION,
    TRAN_CONV_BUS_AWUSER,
    TRAN_CONV_BUS_WVALID,
    TRAN_CONV_BUS_WREADY,
    TRAN_CONV_BUS_WDATA,
    TRAN_CONV_BUS_WSTRB,
    TRAN_CONV_BUS_WLAST,
    TRAN_CONV_BUS_WID,
    TRAN_CONV_BUS_WUSER,
    TRAN_CONV_BUS_ARVALID,
    TRAN_CONV_BUS_ARREADY,
    TRAN_CONV_BUS_ARADDR,
    TRAN_CONV_BUS_ARID,
    TRAN_CONV_BUS_ARLEN,
    TRAN_CONV_BUS_ARSIZE,
    TRAN_CONV_BUS_ARBURST,
    TRAN_CONV_BUS_ARLOCK,
    TRAN_CONV_BUS_ARCACHE,
    TRAN_CONV_BUS_ARPROT,
    TRAN_CONV_BUS_ARQOS,
    TRAN_CONV_BUS_ARREGION,
    TRAN_CONV_BUS_ARUSER,
    TRAN_CONV_BUS_RVALID,
    TRAN_CONV_BUS_RREADY,
    TRAN_CONV_BUS_RDATA,
    TRAN_CONV_BUS_RLAST,
    TRAN_CONV_BUS_RID,
    TRAN_CONV_BUS_RUSER,
    TRAN_CONV_BUS_RRESP,
    TRAN_CONV_BUS_BVALID,
    TRAN_CONV_BUS_BREADY,
    TRAN_CONV_BUS_BRESP,
    TRAN_CONV_BUS_BID,
    TRAN_CONV_BUS_BUSER,
    ready,
...
//------------------------Parameter----------------------
`define TV_IN_CONV_BUS "../tv/cdatafile/c.top.autotvin_CONV_BUS.dat"
`define TV_OUT_CONV_BUS "../tv/rtldatafile/rtl.top.autotvout_CONV_BUS.dat"
 parameter CONV_BUS_ADDR_BITWIDTH = 32'd 64;
 parameter CONV_BUS_AWUSER_BITWIDTH = 32'd 1;
 parameter CONV_BUS_DATA_BITWIDTH = 32'd 512;
 parameter CONV_BUS_WUSER_BITWIDTH = 32'd 1;
 parameter CONV_BUS_ID_BITWIDTH = 32'd 1;
 parameter CONV_BUS_RUSER_BITWIDTH = 32'd 1;
 parameter CONV_BUS_BUSER_BITWIDTH = 32'd 1;
 parameter   FIFO_DEPTH            =   1 + 1;
 parameter   mem_page_num            =   32'd 4;
 parameter   FIFO_DEPTH_ADDR_WIDTH   =    32'd 32;
parameter CONV_BUS_C_DATA_BITWIDTH = 32'd 512;
parameter CONV_BUS_transaction_depth = 32'd 5000;
parameter CONV_BUS_mem_depth = 32'd 5000;
parameter ReadReqLatency = 32'd 1;
parameter WriteReqLatency = 32'd 1;
// Input and Output
input clk;
input reset;
input  TRAN_CONV_BUS_AWVALID;
output  TRAN_CONV_BUS_AWREADY;
input [CONV_BUS_ADDR_BITWIDTH - 1 : 0] TRAN_CONV_BUS_AWADDR;
input [CONV_BUS_ID_BITWIDTH - 1 : 0] TRAN_CONV_BUS_AWID;
input [8 - 1 : 0] TRAN_CONV_BUS_AWLEN;
input [3 - 1 : 0] TRAN_CONV_BUS_AWSIZE;
input [2 - 1 : 0] TRAN_CONV_BUS_AWBURST;
input [2 - 1 : 0] TRAN_CONV_BUS_AWLOCK;
input [4 - 1 : 0] TRAN_CONV_BUS_AWCACHE;
input [3 - 1 : 0] TRAN_CONV_BUS_AWPROT;
input [4 - 1 : 0] TRAN_CONV_BUS_AWQOS;
input [4 - 1 : 0] TRAN_CONV_BUS_AWREGION;
input [CONV_BUS_AWUSER_BITWIDTH - 1 : 0] TRAN_CONV_BUS_AWUSER;
input  TRAN_CONV_BUS_WVALID;
output  TRAN_CONV_BUS_WREADY;
input [CONV_BUS_DATA_BITWIDTH - 1 : 0] TRAN_CONV_BUS_WDATA;
input [CONV_BUS_DATA_BITWIDTH/8 - 1 : 0] TRAN_CONV_BUS_WSTRB;
input  TRAN_CONV_BUS_WLAST;
input  TRAN_CONV_BUS_WID;
input [CONV_BUS_WUSER_BITWIDTH - 1 : 0] TRAN_CONV_BUS_WUSER;
input  TRAN_CONV_BUS_ARVALID;
output  TRAN_CONV_BUS_ARREADY;
input [CONV_BUS_ADDR_BITWIDTH - 1 : 0] TRAN_CONV_BUS_ARADDR;
input [CONV_BUS_ID_BITWIDTH - 1 : 0] TRAN_CONV_BUS_ARID;
input [8 - 1 : 0] TRAN_CONV_BUS_ARLEN;
input [3 - 1 : 0] TRAN_CONV_BUS_ARSIZE;
input [2 - 1 : 0] TRAN_CONV_BUS_ARBURST;
input [2 - 1 : 0] TRAN_CONV_BUS_ARLOCK;
input [4 - 1 : 0] TRAN_CONV_BUS_ARCACHE;
input [3 - 1 : 0] TRAN_CONV_BUS_ARPROT;
input [4 - 1 : 0] TRAN_CONV_BUS_ARQOS;
input [4 - 1 : 0] TRAN_CONV_BUS_ARREGION;
input  TRAN_CONV_BUS_ARUSER;
output  TRAN_CONV_BUS_RVALID;
input  TRAN_CONV_BUS_RREADY;
output [CONV_BUS_DATA_BITWIDTH - 1 : 0] TRAN_CONV_BUS_RDATA;
output  TRAN_CONV_BUS_RLAST;
output [CONV_BUS_ID_BITWIDTH - 1 : 0] TRAN_CONV_BUS_RID;
output [CONV_BUS_RUSER_BITWIDTH - 1 : 0] TRAN_CONV_BUS_RUSER;
output [2 - 1 : 0] TRAN_CONV_BUS_RRESP;
output  TRAN_CONV_BUS_BVALID;
input  TRAN_CONV_BUS_BREADY;
output [2 - 1 : 0] TRAN_CONV_BUS_BRESP;
output [CONV_BUS_ID_BITWIDTH - 1 : 0] TRAN_CONV_BUS_BID;
output [CONV_BUS_BUSER_BITWIDTH - 1 : 0] TRAN_CONV_BUS_BUSER;
input ready;
input done;

// Inner signals
// AW request fifo
reg    [CONV_BUS_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [CONV_BUS_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR_tmp; 
...
// AR request fifo
reg    [CONV_BUS_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [CONV_BUS_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR_tmp; 
...
// WDATA fifo
reg    [CONV_BUS_DATA_BITWIDTH - 1 : 0]         FIFO_WDATA           [0 : FIFO_DEPTH - 1]; 
reg    [CONV_BUS_DATA_BITWIDTH/8 - 1 : 0]       FIFO_WSTRB           [0 : FIFO_DEPTH - 1]; 
...
reg    BRESP_tmp = 0;
reg    [CONV_BUS_ID_BITWIDTH - 1 : 0] BID_tmp = 0;
reg    send_one_BRESP = 0;
reg    [31 : 0] BRESP_counter = 0;

reg [CONV_BUS_DATA_BITWIDTH - 1:0] RDATA_tmp = 0;
reg [2 - 1:0] RRESP_tmp = 0;
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [CONV_BUS_ID_BITWIDTH - 1 : 0] RID_tmp = 0;
reg [CONV_BUS_DATA_BITWIDTH - 1 : 0] CONV_BUS_mem_0 [0: CONV_BUS_mem_depth - 1] = '{default : 'h0}; 
reg [CONV_BUS_DATA_BITWIDTH - 1 : 0] CONV_BUS_mem_1 [0: CONV_BUS_mem_depth - 1] = '{default : 'h0}; 
reg [CONV_BUS_DATA_BITWIDTH - 1 : 0] CONV_BUS_mem_2 [0: CONV_BUS_mem_depth - 1] = '{default : 'h0}; 
reg [CONV_BUS_DATA_BITWIDTH - 1 : 0] CONV_BUS_mem_3 [0: CONV_BUS_mem_depth - 1] = '{default : 'h0}; 
reg [31 : 0] clk_counter ;
reg [31 : 0] current_AW_req_transaction = 0 ;
reg [31 : 0] current_AR_req_transaction = -1 ;
reg write_processing = 0;
reg [CONV_BUS_ADDR_BITWIDTH - 1 : 0] wr_processing_addr = 0;
reg [CONV_BUS_ADDR_BITWIDTH - 1 : 0] rd_processing_addr = 0;
reg [31 : 0] wr_processing_trans_num = 0;
reg [CONV_BUS_DATA_BITWIDTH - 1 : 0] wr_processing_data = 0;
assign TRAN_CONV_BUS_AWREADY    =    !FIFO_AW_req_full; 
assign TRAN_CONV_BUS_ARREADY    =    !FIFO_AR_req_full; 
assign TRAN_CONV_BUS_WREADY    =     !(FIFO_WDATA_req_full || FIFO_WDATA_size_full); 
assign TRAN_CONV_BUS_BVALID = (BRESP_counter == 0) ? 0 : 1;
assign TRAN_CONV_BUS_BRESP = BRESP_tmp;
assign TRAN_CONV_BUS_BID = BID_tmp;
assign TRAN_CONV_BUS_RDATA = RDATA_tmp;
assign TRAN_CONV_BUS_RRESP = RRESP_tmp;
assign TRAN_CONV_BUS_RLAST = RLAST_tmp;
assign TRAN_CONV_BUS_RID = RID_tmp;
assign TRAN_CONV_BUS_RVALID = RVALID_tmp;

initial begin : initialize_offset
  integer DATA_byte_num; 
  integer c_bitwidth;
  DATA_byte_num = 0; 
  c_bitwidth = CONV_BUS_C_DATA_BITWIDTH;
end
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_CONV_BUS_AWREADY & TRAN_CONV_BUS_AWVALID ) begin    // RTL is sending a AW_request to the bus         
            FIFO_AW_req_SIZE [FIFO_AW_req_ptr_w]    =   TRAN_CONV_BUS_AWSIZE; 
            FIFO_AW_req_ADDR [FIFO_AW_req_ptr_w]    =   TRAN_CONV_BUS_AWADDR; 
            FIFO_AW_req_LEN  [FIFO_AW_req_ptr_w]    =   TRAN_CONV_BUS_AWLEN; 
            FIFO_AW_req_BURST[FIFO_AW_req_ptr_w]    =   TRAN_CONV_BUS_AWBURST; 
            FIFO_AW_req_ID[FIFO_AW_req_ptr_w]    =   TRAN_CONV_BUS_AWID; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_CONV_BUS_ARREADY & TRAN_CONV_BUS_ARVALID ) begin    // RTL is sending a AR_request to the bus         
            FIFO_AR_req_SIZE [FIFO_AR_req_ptr_w]    =   TRAN_CONV_BUS_ARSIZE; 
            FIFO_AR_req_ADDR [FIFO_AR_req_ptr_w]    =   TRAN_CONV_BUS_ARADDR; 
            FIFO_AR_req_LEN  [FIFO_AR_req_ptr_w]    =   TRAN_CONV_BUS_ARLEN; 
            FIFO_AR_req_BURST[FIFO_AR_req_ptr_w]    =   TRAN_CONV_BUS_ARBURST; 
            FIFO_AR_req_ID[FIFO_AR_req_ptr_w]    =   TRAN_CONV_BUS_ARID; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_CONV_BUS_WREADY & TRAN_CONV_BUS_WVALID) begin    // RTL is sending a WDATA data 
            FIFO_WDATA [FIFO_WDATA_req_ptr_w]    <=   TRAN_CONV_BUS_WDATA; 
            FIFO_WSTRB [FIFO_WDATA_req_ptr_w]    <=   TRAN_CONV_BUS_WSTRB; 
            if(FIFO_WDATA_req_ptr_w != FIFO_DEPTH - 1) 
                FIFO_WDATA_req_ptr_w <= FIFO_WDATA_req_ptr_w + 1; 
            else 
                FIFO_WDATA_req_ptr_w <= 0; 
            if (TRAN_CONV_BUS_WLAST == 1 ) begin
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_CONV_BUS_AWVALID && TRAN_CONV_BUS_AWREADY && ((FIFO_AW_req_ptr_w - FIFO_AW_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AW_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_CONV_BUS_ARVALID && TRAN_CONV_BUS_ARREADY && ((FIFO_AR_req_ptr_w - FIFO_AR_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AR_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_CONV_BUS_WVALID && TRAN_CONV_BUS_WREADY && ((FIFO_WDATA_req_ptr_w - FIFO_WDATA_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_CONV_BUS_WVALID && TRAN_CONV_BUS_WREADY && TRAN_CONV_BUS_WLAST && ((FIFO_WDATA_size_ptr_w - FIFO_WDATA_size_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if ( send_one_BRESP == 'b1 && !(BRESP_counter != 32'h0 && TRAN_CONV_BUS_BREADY) ) begin
            BRESP_counter <= BRESP_counter + 1;
        end else if (send_one_BRESP != 'b1 && (BRESP_counter != 32'h0 && TRAN_CONV_BUS_BREADY)) begin
            BRESP_counter <= BRESP_counter - 1;
        end
    end
end
...
initial begin : AW_request_proc
    ...
    reg [CONV_BUS_DATA_BITWIDTH - 1 : 0] FIFO_WDATA_tmp;
    reg [CONV_BUS_DATA_BITWIDTH - 1 : 0] WDATA_tmp;
    reg [CONV_BUS_DATA_BITWIDTH/8 - 1 : 0] FIFO_WSTRB_tmp;
    @(posedge clk);
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > CONV_BUS_mem_depth) begin
                $display ("D:/Download/SDA/SDA/solution1/sim/verilog/AESL_axi_master_CONV_BUS.v: Write request address %d exceed AXI master CONV_BUS array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, CONV_BUS_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AW_req_BURST_tmp === 1) begin
                ...
                while (counter != output_length + 1) begin
                    if (FIFO_WDATA_req_empty != 1) begin 
                            ...
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = CONV_BUS_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        1 : WDATA_tmp[j] = CONV_BUS_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        2 : WDATA_tmp[j] = CONV_BUS_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        3 : WDATA_tmp[j] = CONV_BUS_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                        ...
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : CONV_BUS_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            1 : CONV_BUS_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            2 : CONV_BUS_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            3 : CONV_BUS_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
                    ...
                    if (FIFO_WDATA_req_empty != 1) begin 
                        ...
                        for (i = 0 ; i < data_byte_size; i = i + 1) begin
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = CONV_BUS_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        1 : WDATA_tmp[j] = CONV_BUS_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        2 : WDATA_tmp[j] = CONV_BUS_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        3 : WDATA_tmp[j] = CONV_BUS_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        default: $display("The page_num of AXI write is not valid!");
                                    endcase
                                end
                            end
                        ...
                        wr_processing_data = WDATA_tmp;
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : CONV_BUS_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            1 : CONV_BUS_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            2 : CONV_BUS_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            3 : CONV_BUS_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
...
initial begin : AR_request_proc
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > CONV_BUS_mem_depth) begin
                $display ("D:/Download/SDA/SDA/solution1/sim/verilog/AESL_axi_master_CONV_BUS.v: Read request address %d exceed AXI master CONV_BUS array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, CONV_BUS_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AR_req_BURST_tmp === 1) begin
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= CONV_BUS_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            1 : RDATA_tmp <= CONV_BUS_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            2 : RDATA_tmp <= CONV_BUS_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            3 : RDATA_tmp <= CONV_BUS_mem_3[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                    ...
                    @(posedge clk);
                    if (RVALID_tmp && TRAN_CONV_BUS_RREADY) begin
                        counter = counter + 1;
                    end 
                end
                RVALID_tmp <= 0;
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= CONV_BUS_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            1 : RDATA_tmp <= CONV_BUS_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            2 : RDATA_tmp <= CONV_BUS_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            3 : RDATA_tmp <= CONV_BUS_mem_3[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            default: $display("The page_num of AXI read is not valid!");
                        endcase
                    RVALID_tmp <= 1;
                    RRESP_tmp <= 0;
...
initial begin : read_file_process 
  ...
  reg [CONV_BUS_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  integer i; 
  transaction_num = 0;
  fp = $fopen(`TV_IN_CONV_BUS,"rb"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_CONV_BUS); 
      $finish; 
  end 
  ...
  while (trans_depth != 64'h5a5aa5a50f0ff0f0)  begin
      ...
      mem_tmp[CONV_BUS_DATA_BITWIDTH - 1: 0] = 0;
      for(i = 0; i < CONV_BUS_transaction_depth; i = i + 1) begin 
          ...
          if (i%1 == 0) begin
              case(mem_page)
                  0 : CONV_BUS_mem_0[i/1] = mem_tmp;
                  1 : CONV_BUS_mem_1[i/1] = mem_tmp;
                  2 : CONV_BUS_mem_2[i/1] = mem_tmp;
                  3 : CONV_BUS_mem_3[i/1] = mem_tmp;
