...
//------------------------Parameter----------------------
`define TV_IN_MM_BUS "../tv/cdatafile/c.top.autotvin_MM_BUS.dat"
...
input clk;
input reset;
input  TRAN_MM_BUS_AWVALID;
output  TRAN_MM_BUS_AWREADY;
input [MM_BUS_ADDR_BITWIDTH - 1 : 0] TRAN_MM_BUS_AWADDR;
input [MM_BUS_ID_BITWIDTH - 1 : 0] TRAN_MM_BUS_AWID;
input [8 - 1 : 0] TRAN_MM_BUS_AWLEN;
input [3 - 1 : 0] TRAN_MM_BUS_AWSIZE;
input [2 - 1 : 0] TRAN_MM_BUS_AWBURST;
input [2 - 1 : 0] TRAN_MM_BUS_AWLOCK;
input [4 - 1 : 0] TRAN_MM_BUS_AWCACHE;
input [3 - 1 : 0] TRAN_MM_BUS_AWPROT;
input [4 - 1 : 0] TRAN_MM_BUS_AWQOS;
input [4 - 1 : 0] TRAN_MM_BUS_AWREGION;
input [MM_BUS_AWUSER_BITWIDTH - 1 : 0] TRAN_MM_BUS_AWUSER;
input  TRAN_MM_BUS_WVALID;
output  TRAN_MM_BUS_WREADY;
input [MM_BUS_DATA_BITWIDTH - 1 : 0] TRAN_MM_BUS_WDATA;
input [MM_BUS_DATA_BITWIDTH/8 - 1 : 0] TRAN_MM_BUS_WSTRB;
input  TRAN_MM_BUS_WLAST;
input  TRAN_MM_BUS_WID;
input [MM_BUS_WUSER_BITWIDTH - 1 : 0] TRAN_MM_BUS_WUSER;
input  TRAN_MM_BUS_ARVALID;
output  TRAN_MM_BUS_ARREADY;
input [MM_BUS_ADDR_BITWIDTH - 1 : 0] TRAN_MM_BUS_ARADDR;
input [MM_BUS_ID_BITWIDTH - 1 : 0] TRAN_MM_BUS_ARID;
input [8 - 1 : 0] TRAN_MM_BUS_ARLEN;
input [3 - 1 : 0] TRAN_MM_BUS_ARSIZE;
input [2 - 1 : 0] TRAN_MM_BUS_ARBURST;
input [2 - 1 : 0] TRAN_MM_BUS_ARLOCK;
input [4 - 1 : 0] TRAN_MM_BUS_ARCACHE;
input [3 - 1 : 0] TRAN_MM_BUS_ARPROT;
input [4 - 1 : 0] TRAN_MM_BUS_ARQOS;
input [4 - 1 : 0] TRAN_MM_BUS_ARREGION;
input  TRAN_MM_BUS_ARUSER;
output  TRAN_MM_BUS_RVALID;
input  TRAN_MM_BUS_RREADY;
output [MM_BUS_DATA_BITWIDTH - 1 : 0] TRAN_MM_BUS_RDATA;
output  TRAN_MM_BUS_RLAST;
output [MM_BUS_ID_BITWIDTH - 1 : 0] TRAN_MM_BUS_RID;
output [MM_BUS_RUSER_BITWIDTH - 1 : 0] TRAN_MM_BUS_RUSER;
output [2 - 1 : 0] TRAN_MM_BUS_RRESP;
output  TRAN_MM_BUS_BVALID;
input  TRAN_MM_BUS_BREADY;
output [2 - 1 : 0] TRAN_MM_BUS_BRESP;
output [MM_BUS_ID_BITWIDTH - 1 : 0] TRAN_MM_BUS_BID;
output [MM_BUS_BUSER_BITWIDTH - 1 : 0] TRAN_MM_BUS_BUSER;
input ready;
input done;

// Inner signals
// AW request fifo
reg    [MM_BUS_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [MM_BUS_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR_tmp; 
...
// AR request fifo
reg    [MM_BUS_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [MM_BUS_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR_tmp; 
...
// WDATA fifo
reg    [MM_BUS_DATA_BITWIDTH - 1 : 0]         FIFO_WDATA           [0 : FIFO_DEPTH - 1]; 
reg    [MM_BUS_DATA_BITWIDTH/8 - 1 : 0]       FIFO_WSTRB           [0 : FIFO_DEPTH - 1]; 
...
reg    BRESP_tmp = 0;
reg    [MM_BUS_ID_BITWIDTH - 1 : 0] BID_tmp = 0;
reg    send_one_BRESP = 0;
reg    [31 : 0] BRESP_counter = 0;

reg [MM_BUS_DATA_BITWIDTH - 1:0] RDATA_tmp = 0;
reg [2 - 1:0] RRESP_tmp = 0;
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [MM_BUS_ID_BITWIDTH - 1 : 0] RID_tmp = 0;
...
reg [MM_BUS_ADDR_BITWIDTH - 1 : 0] wr_processing_addr = 0;
reg [MM_BUS_ADDR_BITWIDTH - 1 : 0] rd_processing_addr = 0;
reg [31 : 0] wr_processing_trans_num = 0;
reg [MM_BUS_DATA_BITWIDTH - 1 : 0] wr_processing_data = 0;
assign TRAN_MM_BUS_AWREADY    =    !FIFO_AW_req_full; 
assign TRAN_MM_BUS_ARREADY    =    !FIFO_AR_req_full; 
assign TRAN_MM_BUS_WREADY    =     !(FIFO_WDATA_req_full || FIFO_WDATA_size_full); 
assign TRAN_MM_BUS_BVALID = (BRESP_counter == 0) ? 0 : 1;
assign TRAN_MM_BUS_BRESP = BRESP_tmp;
assign TRAN_MM_BUS_BID = BID_tmp;
assign TRAN_MM_BUS_RDATA = RDATA_tmp;
assign TRAN_MM_BUS_RRESP = RRESP_tmp;
assign TRAN_MM_BUS_RLAST = RLAST_tmp;
assign TRAN_MM_BUS_RID = RID_tmp;
assign TRAN_MM_BUS_RVALID = RVALID_tmp;

initial begin : initialize_offset
  integer DATA_byte_num; 
  integer c_bitwidth;
  DATA_byte_num = 0; 
  c_bitwidth = MM_BUS_C_DATA_BITWIDTH;
end
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_MM_BUS_AWREADY & TRAN_MM_BUS_AWVALID ) begin    // RTL is sending a AW_request to the bus         
            FIFO_AW_req_SIZE [FIFO_AW_req_ptr_w]    =   TRAN_MM_BUS_AWSIZE; 
            FIFO_AW_req_ADDR [FIFO_AW_req_ptr_w]    =   TRAN_MM_BUS_AWADDR; 
            FIFO_AW_req_LEN  [FIFO_AW_req_ptr_w]    =   TRAN_MM_BUS_AWLEN; 
            FIFO_AW_req_BURST[FIFO_AW_req_ptr_w]    =   TRAN_MM_BUS_AWBURST; 
            FIFO_AW_req_ID[FIFO_AW_req_ptr_w]    =   TRAN_MM_BUS_AWID; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_MM_BUS_ARREADY & TRAN_MM_BUS_ARVALID ) begin    // RTL is sending a AR_request to the bus         
            FIFO_AR_req_SIZE [FIFO_AR_req_ptr_w]    =   TRAN_MM_BUS_ARSIZE; 
            FIFO_AR_req_ADDR [FIFO_AR_req_ptr_w]    =   TRAN_MM_BUS_ARADDR; 
            FIFO_AR_req_LEN  [FIFO_AR_req_ptr_w]    =   TRAN_MM_BUS_ARLEN; 
            FIFO_AR_req_BURST[FIFO_AR_req_ptr_w]    =   TRAN_MM_BUS_ARBURST; 
            FIFO_AR_req_ID[FIFO_AR_req_ptr_w]    =   TRAN_MM_BUS_ARID; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_MM_BUS_WREADY & TRAN_MM_BUS_WVALID) begin    // RTL is sending a WDATA data 
            FIFO_WDATA [FIFO_WDATA_req_ptr_w]    <=   TRAN_MM_BUS_WDATA; 
            FIFO_WSTRB [FIFO_WDATA_req_ptr_w]    <=   TRAN_MM_BUS_WSTRB; 
            if(FIFO_WDATA_req_ptr_w != FIFO_DEPTH - 1) 
                FIFO_WDATA_req_ptr_w <= FIFO_WDATA_req_ptr_w + 1; 
            else 
                FIFO_WDATA_req_ptr_w <= 0; 
            if (TRAN_MM_BUS_WLAST == 1 ) begin
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_MM_BUS_AWVALID && TRAN_MM_BUS_AWREADY && ((FIFO_AW_req_ptr_w - FIFO_AW_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AW_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_MM_BUS_ARVALID && TRAN_MM_BUS_ARREADY && ((FIFO_AR_req_ptr_w - FIFO_AR_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AR_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_MM_BUS_WVALID && TRAN_MM_BUS_WREADY && ((FIFO_WDATA_req_ptr_w - FIFO_WDATA_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_MM_BUS_WVALID && TRAN_MM_BUS_WREADY && TRAN_MM_BUS_WLAST && ((FIFO_WDATA_size_ptr_w - FIFO_WDATA_size_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if ( send_one_BRESP == 'b1 && !(BRESP_counter != 32'h0 && TRAN_MM_BUS_BREADY) ) begin
            BRESP_counter <= BRESP_counter + 1;
        end else if (send_one_BRESP != 'b1 && (BRESP_counter != 32'h0 && TRAN_MM_BUS_BREADY)) begin
            BRESP_counter <= BRESP_counter - 1;
        end
    end
end
...
initial begin : AW_request_proc
    ...
    reg [MM_BUS_DATA_BITWIDTH - 1 : 0] FIFO_WDATA_tmp;
    reg [MM_BUS_DATA_BITWIDTH - 1 : 0] WDATA_tmp;
    reg [MM_BUS_DATA_BITWIDTH/8 - 1 : 0] FIFO_WSTRB_tmp;
    @(posedge clk);
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_BURST_tmp === 1) begin
                ...
                while (counter != input_length + 1) begin
                    ...
                    @(posedge clk);
                    if (RVALID_tmp && TRAN_MM_BUS_RREADY) begin
                        counter = counter + 1;
                    end 
                end
                RVALID_tmp <= 0;
...
initial begin : read_file_process 
  ...
  integer i; 
  transaction_num = 0;
  fp = $fopen(`TV_IN_MM_BUS,"rb"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_MM_BUS); 
      $finish; 
  end 
