...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { fifo_conv_w_0_din { O 128 vector } fifo_conv_w_0_full_n { I 1 bit } fifo_conv_w_0_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { fifo_conv_w_1_din { O 128 vector } fifo_conv_w_1_full_n { I 1 bit } fifo_conv_w_1_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { fifo_conv_w_2_din { O 128 vector } fifo_conv_w_2_full_n { I 1 bit } fifo_conv_w_2_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { fifo_conv_w_3_din { O 128 vector } fifo_conv_w_3_full_n { I 1 bit } fifo_conv_w_3_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { fifo_mm_w_din { O 128 vector } fifo_mm_w_full_n { I 1 bit } fifo_mm_w_write { O 1 bit } } \
} "
}
