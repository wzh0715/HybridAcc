...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_mul_ln25_7 \
    op interface \
    ports { mul_ln25_7 { I 120 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_conv_a \
    op interface \
    ports { conv_a_din { O 128 vector } conv_a_full_n { I 1 bit } conv_a_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_mul_ln25_6 \
    op interface \
    ports { mul_ln25_6 { I 92 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_mul_ln25_5 \
    op interface \
    ports { mul_ln25_5 { I 60 vector } } \
} "
}
