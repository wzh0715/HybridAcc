...
architecture rtl of top_fifo_w32_d32_S is

    component top_fifo_w32_d32_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 5;
        DEPTH      : integer := 32);
...
begin
----------------------- Instantiation -----------------------
    U_top_fifo_w32_d32_S_ShiftReg : top_fifo_w32_d32_S_ShiftReg
    generic map (
...
entity top_fifo_w32_d32_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 5;
        DEPTH      : integer := 32);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end top_fifo_w32_d32_S_ShiftReg;

architecture rtl of top_fifo_w32_d32_S_ShiftReg is
