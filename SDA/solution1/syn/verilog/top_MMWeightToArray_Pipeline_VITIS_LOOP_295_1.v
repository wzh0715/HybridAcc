...
module top_MMWeightToArray_Pipeline_VITIS_LOOP_295_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [29:0] rep_fu_82;
wire   [29:0] rep_5_fu_224_p2;
wire    ap_loop_init;
reg    ap_block_pp0_stage0_11001;
reg   [29:0] ap_sig_allocacmp_rep_4;
wire   [127:0] trunc_ln302_fu_235_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln295_fu_218_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln295_fu_218_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign MM_SA_W_10_din = {{fifo_mm_w_dout[383:256]}};

assign MM_SA_W_11_din = {{fifo_mm_w_dout[511:384]}};

assign MM_SA_W_12_din = trunc_ln302_fu_235_p1;

assign MM_SA_W_13_din = {{fifo_mm_w_dout[255:128]}};

assign MM_SA_W_14_din = {{fifo_mm_w_dout[383:256]}};

assign MM_SA_W_15_din = {{fifo_mm_w_dout[511:384]}};

assign MM_SA_W_1_din = {{fifo_mm_w_dout[255:128]}};

assign MM_SA_W_2_din = {{fifo_mm_w_dout[383:256]}};

assign MM_SA_W_3_din = {{fifo_mm_w_dout[511:384]}};

assign MM_SA_W_4_din = trunc_ln302_fu_235_p1;

assign MM_SA_W_5_din = {{fifo_mm_w_dout[255:128]}};

assign MM_SA_W_6_din = {{fifo_mm_w_dout[383:256]}};

assign MM_SA_W_7_din = {{fifo_mm_w_dout[511:384]}};

assign MM_SA_W_8_din = trunc_ln302_fu_235_p1;

assign MM_SA_W_9_din = {{fifo_mm_w_dout[255:128]}};

assign MM_SA_W_din = trunc_ln302_fu_235_p1;
...
assign icmp_ln295_fu_218_p2 = ((ap_sig_allocacmp_rep_4 == p_read) ? 1'b1 : 1'b0);

assign rep_5_fu_224_p2 = (ap_sig_allocacmp_rep_4 + 30'd1);

assign trunc_ln302_fu_235_p1 = fifo_mm_w_dout[127:0];

endmodule //top_MMWeightToArray_Pipeline_VITIS_LOOP_295_1
